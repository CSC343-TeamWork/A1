...
CREATE TABLE IF NOT EXISTS Passenger(
  ...
  CONSTRAINT SINEF_FK FOREIGN KEY (SIN) REFERENCES Person(SIN),
  CONSTRAINT PASSEND_FK FOREIGN KEY (PassengerType) REFERENCES Fare(type),
  PRIMARY KEY(SIN,PassengerType)
);
...
CREATE TABLE IF NOT EXISTS AssociatedWith(
  ...
  CONSTRAINT SINE_FK FOREIGN KEY (SIN) REFERENCES Passenger(SIN),
